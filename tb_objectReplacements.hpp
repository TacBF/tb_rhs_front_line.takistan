...
//FO's
	...
	class ICE_staticWeaponCrates_supplyEast_noMortarATAA
	{
     	crateContents[] = {
     	...
     	//crateMass = 1750;
     	proxyObject = "ICE_staticWeaponCrates_supplyEast_noMortarATAA";
	};
	class ICE_staticWeaponCrates_supplyWest_noMortarATAA
	{
     	crateContents[] = {
        	RDS_TOW_TriPod_AAF
       	// 	{RDS_M2StaticMG_AAF, 2},
     	...
     	//crateMass = 1750;
     	proxyObject = "ICE_staticWeaponCrates_supplyWest_noMortarATAA";
	};
